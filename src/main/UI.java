...
public class UI {
    ...
    public void drawShop() {
        ...
        for (int i = 0; i < 4; i++){
            ...
            BufferedImage coinImage = coin.defaultList.getFirst();
        ...
        g2.setFont(arcade);
        if (slotRow == 0){
            g2.drawString(bs.getShopItems().getFirst().description, textX, textY);
            g2.drawString("Damage: " + bs.getShopItems().getFirst().damage, textX, textY+30);
