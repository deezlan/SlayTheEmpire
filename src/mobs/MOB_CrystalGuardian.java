...
public class MOB_CrystalGuardian extends Entity {
    GamePanel gp;
    public MOB_CrystalGuardian(GamePanel gp) {
        super(gp);
        this.gp = gp;
        type = 2;
        speed = 1;
    ...
    @Override
    public void setAction() { // ARTILERY MOB
        actionLockCounter++;
    ...
    public void getMobSprites() {
        String dir = "/Mobs/CrystalGuardian/";
        try {
            for (int i = 0; i <= 3; i++) {
...
//            UtilityTool.scaleEntityList(this,idleLeftList, 150, 150);
            UtilityTool.scaleEntityList(this, idleRightList, 230, 100);
